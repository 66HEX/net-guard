            ...
            <div className="w-full h-full p-3">
                <div className="flex flex-col items-center justify-center  rounded-[2rem] border border-green-900/20 z-30">
                    <div className="max-w-6xl mx-auto text-center space-y-4 md:space-y-6 mb-8 md:mb-12">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center pt-4 items-center">
                            ...
                            <button className="text-white px-6 py-3 rounded-full font-medium backdrop-blur-md bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.05] transition-colors text-sm md:text-base">
                                Join Wait List
                            </button>
                        </div>
                    </div>
